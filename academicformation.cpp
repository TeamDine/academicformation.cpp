...
Formation::Formation(const std::string& n,std::string& i,Date& b,Date& f,Date& d,std::string& id) : gradeName(n),institution(i),beginDate(b),finishDate(f),degreeDate(d),idCard(id) {}
